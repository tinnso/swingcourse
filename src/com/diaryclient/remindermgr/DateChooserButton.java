...
public class DateChooserButton extends JButton {
    ...
    public DateChooserButton(String dateString) {
        this();
    ...
    public DateChooserButton(SimpleDateFormat df, String dateString) {
        this();
    ...
    public DateChooserButton(Date date) {
        this("", date);
        //记忆原始日期时间
        initOriginalText(date);
    }
 
    public DateChooserButton(String preLabel, Date date) {
        if (preLabel != null) {
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        void showDateChooser(Point position) {
            Frame owner = (Frame) SwingUtilities.getWindowAncestor(DateChooserButton.this);
